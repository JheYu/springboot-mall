...
import com.denis.springboot_mall.util.Page;
...
public class OrderController {
    ...
    public ResponseEntity<Page<Order>> getOrders(
        ...
        //取得 order List
        List<Order> orderList = orderServie.getOrders(orderQueryParams);

        //取得 order 總數
        Integer count = orderServie.countOrder(orderQueryParams);
